...
Based on provided credentials, the server will automatically exposes the corresponding tools:
...
Leaving placeholder values will result in exposed tools which does not work.**
